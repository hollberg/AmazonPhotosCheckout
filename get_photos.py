...
save_path = r'C:\Users\mitchell.hollberg\Downloads\AmazonPhotos'
...
for year_button in year_buttons:
    ...
    for month_button in month_buttons:
        ...
        driver.execute_script(f'window.scrollTo({button_x}, {button_y - 125})')
        current_month = month_button.text[:4]
        month_button.click()
        time.sleep(.5)

        days_list = fn.find_by_day_elements()
        ...
        for day in days_list:
            ...
            current_days_list = fn.find_by_day_elements()
